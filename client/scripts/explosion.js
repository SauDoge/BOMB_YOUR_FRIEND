...
const Explosion = function(ctx, x, y, type) {
    ...
    const sequences = { 
        ...
        center: { x: 0, y:  64, width: 64, height: 64, count: 4, timing: 300, loop: false },
        h_mid: { x: 0, y:  128, width: 64, height: 64, count: 4, timing: 300, loop: false },
        right: { x: 0, y:  192, width: 64, height: 64, count: 4, timing: 300, loop: false },
        left: { x: 0, y:  256, width: 64, height: 64, count: 4, timing: 300, loop: false },
        v_mid: { x: 0, y:  320, width: 64, height: 64, count: 4, timing: 300, loop: false },
        up: { x: 0, y:  384, width: 64, height: 64, count: 4, timing: 300, loop: false },
        down: { x: 0, y:  448, width: 64, height: 64, count: 4, timing: 300, loop: false }
