...
const BoundingBox = function(ctx, top, left, bottom, right) {
    ...
    //
    // `Path2D()` creates a new path that can be re-used by the canvas context. 
    // This path is used to detect the intersection of a point or a box against this bounding box.
