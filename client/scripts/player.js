...
const Player = function (ctx, x, y, gameArea, type) {
  ...
  const sequences = {
    ...
    idleUp: {
      x: 0,
      y: (CHARACTER_HEIGHT + Y_PADDING) * type,
    ...
    dead: {
      x: (CHARACTER_WIDTH + X_PADDING) * 15,
      y: (CHARACTER_HEIGHT + Y_PADDING) * type,
      width: CHARACTER_WIDTH,
      height: CHARACTER_HEIGHT,
      count: 2,
